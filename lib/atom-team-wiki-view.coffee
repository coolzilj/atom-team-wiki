...
module.exports =
class AtomTeamWikiView extends ScrollView
  @content: ->
    @div class: 'atom-team-wiki', =>
      @div class: 'atom-team-wiki-container', =>
        @header class: 'atom-team-wiki-header', =>
          @raw '<svg class="atom-team-wiki-logo" width="330px" height="68px" viewBox="0 0 330 68" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
          ...
          @h1 class: 'atom-team-wiki-title', 'A hackable text editor for the 21st Century'

        @section class: 'atom-team-wiki-panel', =>
          ...
          @p class: 'atom-team-wiki-note atom-team-wiki-metrics', =>
            @raw '''
        ...
        @footer class: 'atom-team-wiki-footer', =>
  ...
  getTitle: -> "Welcome to Team Wiki"

  onDidChangeTitle: -> new Disposable ->
  onDidChangeModified: -> new Disposable ->

  isEqual: (other) ->
    other instanceof AtomTeamWikiView
